...
#define dwForceAttack = 0x31D7734;
#define dwForceAttack2 = 0x31D7740;
#define dwForceBackward = 0x31D777C;
#define dwForceForward = 0x31D7788;
#define dwForceJump = 0x5250FFC;
#define dwForceLeft = 0x31D77A0;
#define dwForceRight = 0x31D7794;
#define dwGameDir = 0x628800;
#define dwGameRulesProxy = 0x52C42EC;
#define dwGetAllClasses = 0xDB601C;
#define dwGlobalVars = 0x589CE8;
#define dwGlowObjectManager = 0x52EF6C8;
#define dwInput = 0x51F87D0;
#define dwInterfaceLinkList = 0x947BF4;
#define dwLocalPlayer = 0xD8E2CC;
#define dwMouseEnable = 0xD93E70;
#define dwMouseEnablePtr = 0xD93E40;
#define dwPlayerResource = 0x31D5AC0;
#define dwRadarBase = 0x51DBF84;
#define dwSensitivity = 0xD93D0C;
#define dwSensitivityPtr = 0xD93CE0;
#define dwSetClanTag = 0x8A1B0;
#define dwViewMatrix = 0x4D98B24;
#define dwWeaponTable = 0x51F9290;
#define dwWeaponTableIndex = 0x325C;
#define dwYawPtr = 0xD93AD0;
#define dwZoomSensitivityRatioPtr = 0xD98D70;
#define dwbSendPackets = 0xD779A;
#define dwppDirect3DDevice9 = 0xA7050;
#define find_hud_element = 0x2F7CFA00;
#define force_update_spectator_glow = 0x3AFDFA;
#define interface_engine_cvar = 0x3E9EC;
#define is_c4_owner = 0x3BCA40;
#define m_bDormant = 0xED;
#define m_flSpawnTime = 0xA370;
#define m_pStudioHdr = 0x294C;
#define m_pitchClassPtr = 0x51DC220;
#define m_yawClassPtr = 0xD93AD0;
